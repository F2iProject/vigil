...
class Persona:
    ...
    blocking: bool = True  # if False, findings become observations (non-blocking) and trigger alerts
    alert: bool = False    # if True, findings trigger email alerts regardless of blocking status
...
{VERDICT_SCHEMA}""",
    ...
    blocking=False,  # non-blocking during early dev — findings become observations
    alert=True,      # send email alerts for security findings
)
